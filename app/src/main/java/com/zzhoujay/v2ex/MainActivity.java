...
import com.zzhoujay.v2ex.ui.activity.NodesActivity;
import com.zzhoujay.v2ex.ui.dialog.ContentDialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        icon = (ImageView) header.findViewById(R.id.header_icon);
        name = (TextView) header.findViewById(R.id.header_name);
        bio = (TextView) header.findViewById(R.id.header_bio);
